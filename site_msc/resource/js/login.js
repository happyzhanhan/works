...
var verifyLogin = _verify.create();
//配置父节点，和表单单元【必须】
verifyLogin.configDom('.login-main fieldset', '.login-main fieldset .formSection');
//配置提示信息【必须】
verifyLogin.configMessageFn(loginVerifyMessage);
//配置提示新式类名【必须】
verifyLogin.configStatusClassFn(['succee', 'error', 'activate', 'message']);
//绑定
verifyLogin.trigger();
